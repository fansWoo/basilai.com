	  ...
	  <div class="totem"> </div>
		<div class="boxcontent">
			...
			<img src="app/img/contact_title.png" class="title">
				<div  class="textbox">
					<div class="box">
						<img src="app/img/contact_icon4.png" class="icon" style="top:30px;">
							<div class="leftext a">
								<p Style="border-bottom:1px solid rgba(255,255,255,0.3);">巴斯萊總經銷高維正企業: <br>台北市松仁路258號</p>
					...
					<div class="box">
						...
						<div class="leftext c">
							<p>basilai.craft.beer@<br>basilai.com</p> 
						</div>
					</div>
					<div class="box">
